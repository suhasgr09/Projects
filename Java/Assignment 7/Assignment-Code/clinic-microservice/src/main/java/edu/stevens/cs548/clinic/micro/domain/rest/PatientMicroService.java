...
public class PatientMicroService {
	...
	public Response getPatient(@PathParam("id") String id, @QueryParam("treatments") @DefaultValue("true") String treatments) {
		try {
			...
			PatientDto patientDto = null;
				 ...
				 p = patientDao.getPatient(patientId);
				 patientDto = patientToDto(p, includeTreatments);
	...
	@Produces({ MediaType.APPLICATION_JSON, "text/json" })
	public Response getTreatment(@QueryParam("id") String id, @QueryParam("tid") String tid) {
