...
let rec string_of_expr e =
  ...
  | SetArray(arr,idx,e) -> "SetArray(" ^ string_of_expr arr ^ "," ^ string_of_expr idx ^ "," ^ string_of_expr e ^ ")"
  | GetArray(arr,idx) -> "GetArray(" ^ string_of_expr arr ^ "," ^ string_of_expr idx ^ ")"
  | MakeArray(len,def) -> "MakeArray(" ^ string_of_expr len ^ "," ^ string_of_expr def ^ ")"
  | LengthArray(arr) -> "LengthArray(" ^ string_of_expr arr ^ ")"
